...
bool robot_interfaces__msg__encoder_speed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._encoder_speed.EncoderSpeed", full_classname_dest, 48) == 0);
  }
  robot_interfaces__msg__EncoderSpeed * ros_message = _ros_message;
  {  // left_speed
...
PyObject * robot_interfaces__msg__encoder_speed__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._encoder_speed");
