    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robot_interfaces.msg.EncoderSpeed')
            logger.debug(
...
class EncoderSpeed(metaclass=Metaclass_EncoderSpeed):
    ...
    def left_speed(self, value):
        if self._check_fields:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'left_speed' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def right_speed(self, value):
        if self._check_fields:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'right_speed' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
